            ...
            <div>
              <div className='lg:w-[570px]'>
                ...
                <p className='text__para'>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel id ipsum quos ullam dolor. Dolor sed sequi ea amet voluptates?
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit a perspiciatis similique magni? Quod, commodi.
                </p>
        ...
        <div className="container">
          <div className='flex items-center justify-between flex-col lg:flex-row'>
            ...
            <div className='relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-[0]'>
              ...
              <div className='w-[150x] lg:w-[240px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px]
